...
import ContactEPinFormLWC from 'c/contactEPinFormLWC';

describe('c-contactEPinFormLWC', () => {
    afterEach(() => {
    ...
    it('renders lightning-record-edit-form with given input values', () => {
        ...
        const element = createElement('c-contactEPinFormLWC', {
            is: ContactEPinFormLWC
        });
    ...
    it('renders given set of lightning-output-field`s in specific order', () => {
        const OUTPUT_FIELDS = ['FirstName', 'LastName'];
        const RECORD_ID_INPUT = '0031700000pJRRSAA4';
        const OBJECT_API_NAME_INPUT = 'Contact';
    ...
    it('renders given set of lightning-input-field`s in specific order', () => {
        const INPUT_FIELDS = ['e_Pin__c', 'Birthdate'];
        const RECORD_ID_INPUT = '0031700000pJRRSAA4';
        const OBJECT_API_NAME_INPUT = 'Contact';
